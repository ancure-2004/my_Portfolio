...
import {CanvasRevealEffect} from "./ui/CanavasRevealEffect";
	...
	return (
		<div>
			<button className="relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
				...
				<span className="text-2xl inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-10 py-5 font-bold text-white backdrop-blur-3xl">
					{order}
				</span>
			</button>
		</div>
