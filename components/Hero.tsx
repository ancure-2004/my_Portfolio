				...
				<div className="max-w-[89vw] md:max-w-2xl lg:max-w-[40vw] flex flex-col items-center justify-center lg:items-start lg:pl-10">
					...
					<div className="flex flex-row gap-4 mt-10">
						...
						<a
							...
							<span className="gap-2 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-7 text-sm font-medium text-white backdrop-blur-3xl">
								Download CV
								<FaDownload />
							</span>
						</a>
